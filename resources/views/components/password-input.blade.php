...
<div class="relative" x-data="{ show: false }">
    <input
        ...
        {{ $attributes->merge(['class' => 'auth-input block w-full rounded-lg border border-slate-300 bg-white px-4 py-3 pr-12 text-sm text-slate-900 placeholder:text-slate-400 transition']) }}
    />
